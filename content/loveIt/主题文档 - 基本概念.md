...
featuredImage: "https://cdn.chiga.ga/Posts/Loveit/themes-01-featured-image.jpg"
tags: ["LoveIt"]
layout: hide
comment:
  enable: false
...
{{< imgcapcdn src=`/Posts/Loveit/themes-01-basic-configuration-preview.zh-cn.png` alt=基本配置下的预览 >}}
...
{{< admonition type=note title="Hugo 的运行环境" open=true >}}
...
{{< admonition type=tip title="关于 CDN 配置的技巧" open=true >}}
...
{{< admonition type=tip title=关于社交链接配置的技巧 open=true >}}
{{< version 0.2.0 >}}
...
{{< imgcapcdn src=`/Posts/Loveit/themes-01-complete-configuration-preview.zh-cn.png` alt=完整配置下的预览 >}}
...
{{< imgcapcdn src=`/Posts/Loveit/themes-01-language-switch.gif` alt=语言切换 width=60% >}}
...
{{< admonition type=note title=怎样选择搜索引擎? open=true >}}
以下是两种搜索引擎的对比:
...
{{< admonition type=tip title="关于 algolia 的使用技巧" open=true >}}
